...
png('bermudaprofile.png', width=7, height=7, unit='in', res=200, pointsize= 14)
mapPlot(coastlineWorldFine, longitudelim=belon, latitudelim=belat, col="pink")
mapPoints(lonbe,latbe)
```