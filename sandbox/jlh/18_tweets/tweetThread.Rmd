...
# Tweet 4
Users can easily sift through data based on geographical region, parameter, time, institution, deep Argo, id, ocean, mode, cycle, direction, and column. A series of real-time examples exists at our Youtube channel https://www.youtube.com/channel/UCmVBNwRRGx5sRa1skvfOrvA.
...
# Tweet 6
To subset by ocean "Area", the following code is used. Note: we've also incorporated a subset by polygon to better improve this subset.
