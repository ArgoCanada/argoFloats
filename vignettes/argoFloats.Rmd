...
argoFloats R 08: Introduction to quality control flags | Jaimie Harbin & Dan Kelley | August 12, 2020 | https://www.youtube.com/watch?v=nN4xs0wCnB4
argoFloats R 09: Advanced Quality Control | Dan Kelley & Jaimie Harbin | August 27, 2020 | https://youtu.be/dYzEO5S2GBw
argoFloats R 10: Using adjusted data streams | Dan Kelley & Jaimie Harbin | September 3, 2020 | https://youtu.be/AuauWeUnopc
...
As shown by Figure 1, the next step when working with the `argoFloats` package is to use the `subset()` function to focus on a subset of profiles. The `argoFloats` package provides tools to sift through profiles based on id, time, geography, variable, institution, ocean, dataMode, cycle, direction, and column.
