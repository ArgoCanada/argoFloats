...
# Youtube Videos
Before moving forward it should be noted that a number of youtube videos exist to work through exercises in real time, as shown below.
...
argoFloats R 03: new websie | Jaimie Harbin & Dan Kelley | April 30, 2020 | https://youtu.be/lOvCrRDTmTs

In addition to the videos, sample code can be found at https://github.com/argoCanada/argoFloats/tree/develop/sandbox/videos/02 for each video.
