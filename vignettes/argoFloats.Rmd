...
```{r workflow, echo=FALSE, fig.cap="Figure One: Work flow of the argoFloats package.", fig.height=2.5, fig.width=7, fig.align='center', dev.args=list(pointsize=10), warning=FALSE}
colText <- "darkblue"
colCode <- "black"
library(graphics)
...
```{r, fig.cap="Figure Two: Built in indexMerged demonstrating argo floats within 300 km of Bahamas"}
plot(indexMerged)
```
...
```{r, message=FALSE, fig.cap="Figure Three: Argo floats found within a 100 km radius of Bermuda"}
...
```{r fig.cap="Figure Four: Line A03 section plot made by oce package.", fig.height=4, fig.width=7, fig.align='center', dev.args=list(pointsize=10)}
