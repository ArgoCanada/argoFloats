...
```{r workflow, echo=FALSE, fig.cap="Figure 1: Work flow of the argoFloats package.", fig.height=2.5, fig.width=7, fig.align='center', dev.args=list(pointsize=10), warning=FALSE}
colText <- "darkblue"
colCode <- "black"
library(graphics)
