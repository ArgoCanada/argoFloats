            ...
            if (0 == sum(c("core", "deep", "bgc") %in% input$view)) {
                ...
                for (view in c("core", "deep", "bgc")) {
                    if (view %in% input$view) {
                        ...
                        points(lonlat$lon, lonlat$lat, type="l",lwd=0.5)
                            message("jaimie")
                        }
                    }
                }
