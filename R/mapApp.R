                                             ...
                                             shiny::column(6,
                                                           ...
                                                           shiny::checkboxGroupInput("view",
                                                                                     ...
                                                                                     choices=c("Core"="core", "Deep"="deep",
                                                                                               "BGC"="bgc", "HiRes"="hires",
                                                                                               "Topo."="topo", "Path"="path", "Start"="start", "End"="end", "Lines"="lines"),
